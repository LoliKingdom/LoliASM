...
public class LoliConfig {
    ...
    public void load() {
        ...
        optimizeThaumcraftAspectGeneration = getBoolean("optimizeThaumcraftAspectGeneration", "modfixes", "When Thaumcraft is installed, speed up its crafting-recipe aspect-tag generation, which otherwise rescans the entire crafting registry per item and stalls loading on large modpacks. This option will be ignored when Thaumcraft isn't installed", true);
