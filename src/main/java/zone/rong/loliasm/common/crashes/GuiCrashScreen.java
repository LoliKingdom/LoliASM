...
public class GuiCrashScreen extends GuiProblemScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) { // TODO: localize number of lines
        ...
        drawCenteredString(fontRenderer, I18n.format("loliasm.crashscreen.title"), width / 2, height / 4 - 40, 0xFFFFFF);

        int textColor = 0xD0D0D0;
        int x = width / 2 - 155;
        int y = height / 4;

        drawString(fontRenderer, I18n.format("loliasm.crashscreen.summary"), x, y, textColor);
        ...
        drawString(fontRenderer, I18n.format("loliasm.crashscreen.paragraph3.line3"), x, y += 9, textColor);
        drawString(fontRenderer, I18n.format("loliasm.crashscreen.paragraph3.line4"), x, y + 9, textColor);
