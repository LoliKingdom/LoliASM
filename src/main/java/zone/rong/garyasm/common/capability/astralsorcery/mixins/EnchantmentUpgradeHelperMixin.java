package zone.rong.garyasm.common.capability.astralsorcery.mixins;
...
public class EnchantmentUpgradeHelperMixin {
    ...
    public static void applyAmuletOwner(ItemStack tool, EntityPlayer wearer) {
        ...
        if (cap == null) {
            ...
            ((AmuletHolderCapabilityProviderAccessor) provider).garyasm$defaultImplFastAccess().setHolderUUID(wearer.getUniqueID());
        } else {
