package zone.rong.garyasm.common.modfixes.qmd;
...
public class QMDEventHandler {
    ...
    private static final Class<?> projectileClass = GaryReflector.getClass("lach_01298.qmd.entity.EntityBeamProjectile").get();
