...
public final class BakedQuadPatch {
    ...
    public static byte[] rewriteBakedQuad(byte[] originalClass) {
        ...
        {
            fieldVisitor = writer.visitField(ACC_PROTECTED | ACC_FINAL, GaryLoadingPlugin.isDeobf ? "vertexData" : "field_178215_a", "[I", null, null);
            fieldVisitor.visitEnd();
        }
        {
            fieldVisitor = writer.visitField(ACC_PROTECTED | ACC_FINAL, GaryLoadingPlugin.isDeobf ? "sprite" : "field_187509_d", "Lnet/minecraft/client/renderer/texture/TextureAtlasSprite;", null, null);
            fieldVisitor.visitEnd();
        }
        {
        ...
        }
        {
            ...
            methodVisitor.visitFieldInsn(GETSTATIC, "net/minecraft/client/renderer/vertex/DefaultVertexFormats", GaryLoadingPlugin.isDeobf ? "ITEM" : "field_176599_b", "Lnet/minecraft/client/renderer/vertex/VertexFormat;");
        ...
        }
        {
            ...
            methodVisitor.visitVarInsn(ALOAD, 0);
            methodVisitor.visitVarInsn(ALOAD, 1);
            methodVisitor.visitFieldInsn(PUTFIELD, "net/minecraft/client/renderer/block/model/BakedQuad", GaryLoadingPlugin.isDeobf ? "vertexData" : "field_178215_a", "[I");
            Label l3 = new Label();
            methodVisitor.visitLabel(l3);
            methodVisitor.visitLineNumber(43, l3);
            methodVisitor.visitVarInsn(ALOAD, 0);
            methodVisitor.visitVarInsn(ALOAD, 4);
            methodVisitor.visitFieldInsn(PUTFIELD, "net/minecraft/client/renderer/block/model/BakedQuad", GaryLoadingPlugin.isDeobf ? "sprite" : "field_187509_d", "Lnet/minecraft/client/renderer/texture/TextureAtlasSprite;");
            Label l4 = new Label();
            methodVisitor.visitLabel(l4);
            methodVisitor.visitLineNumber(44, l4);
            /*
            Label startingLabel = null;
            if (GaryConfig.instance.logClassesThatCallBakedQuadCtor) {
                ...
                methodVisitor.visitFieldInsn(GETSTATIC, "zone/rong/garyasm/GaryLogger", "instance", "Lorg/apache/logging/log4j/Logger;");
                methodVisitor.visitLdcInsn("{} needs their BakedQuad calls redirecting! Insert the string into config/garyasm.cfg and report it to Rongmario so it could be added to the GitHub Wiki.");
                methodVisitor.visitVarInsn(ALOAD, 7);
            ...
            */
            ...
            methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[]{"net/minecraft/client/renderer/block/model/BakedQuad", "[I", Opcodes.INTEGER, "net/minecraft/util/EnumFacing", "net/minecraft/client/renderer/texture/TextureAtlasSprite", Opcodes.INTEGER, "net/minecraft/client/renderer/vertex/VertexFormat", "java/lang/Class"}, 0, new Object[]{});
            methodVisitor.visitVarInsn(ALOAD, 7);
            methodVisitor.visitMethodInsn(INVOKESTATIC, "zone/rong/garyasm/core/GaryHooks", "inform", "(Ljava/lang/Class;)V", false);
            Label l8 = new Label();
            methodVisitor.visitLabel(l8);
            methodVisitor.visitLineNumber(49, l8);
            methodVisitor.visitInsn(RETURN);
        ...
        }
        {
            ...
            methodVisitor.visitLocalVariable(GaryLoadingPlugin.isDeobf ? "vertexData" : "field_178215_a", "[I", null, l0, l5, 1);
            methodVisitor.visitLocalVariable(GaryLoadingPlugin.isDeobf ? "sprite" : "field_187509_d", "Lnet/minecraft/client/renderer/texture/TextureAtlasSprite;", null, l0, l5, 2);
        ...
        {
            methodVisitor = writer.visitMethod(ACC_PUBLIC, GaryLoadingPlugin.isDeobf ? "getSprite" : "func_187508_a", "()Lnet/minecraft/client/renderer/texture/TextureAtlasSprite;", null, null);
            methodVisitor.visitCode();
            Label l0 = new Label();
            methodVisitor.visitLabel(l0);
            methodVisitor.visitLineNumber(58, l0);
            methodVisitor.visitVarInsn(ALOAD, 0);
            methodVisitor.visitFieldInsn(GETFIELD, "net/minecraft/client/renderer/block/model/BakedQuad", GaryLoadingPlugin.isDeobf ? "sprite" : "field_187509_d", "Lnet/minecraft/client/renderer/texture/TextureAtlasSprite;");
        ...
        {
            methodVisitor = writer.visitMethod(ACC_PUBLIC, GaryLoadingPlugin.isDeobf ? "getVertexData" : "func_178209_a", "()[I", null, null);
            methodVisitor.visitCode();
            Label l0 = new Label();
            methodVisitor.visitLabel(l0);
