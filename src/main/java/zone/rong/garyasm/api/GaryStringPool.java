...
public class GaryStringPool {
    ...
    public static void onDebugList(RenderGameOverlayEvent.Text event) {
        ...
        if (minecraft.gameSettings.showDebugInfo) {
            ...
            list.add(String.format("%s%s%s: %s strings processed. %s unique, %s deduplicated.", TextFormatting.AQUA, "<GaryASM>", TextFormatting.RESET, deduplicatedCount, size, deduplicatedCount - size));
        }
    }
    ...
    static class Internal {
        ...
        protected void finalize() {
            GaryLogger.instance.warn("Clearing GaryStringPool {}", id);
        }
    }
