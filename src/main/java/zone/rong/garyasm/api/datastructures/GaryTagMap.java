...
import zone.rong.garyasm.api.datastructures.canonical.AutoCanonizingHashMap;
...
public class GaryTagMap<K, V> implements Map<K, V> {

    private Map<K, V> map;
    private final int threshold;

    public GaryTagMap() {
        this(GaryConfig.instance.optimizeNBTTagCompoundMapThreshold, GaryConfig.instance.nbtBackingMapStringCanonicalization, GaryConfig.instance.optimizeNBTTagCompoundBackingMap);
    }

    public GaryTagMap(int threshold, boolean canonicalizeString, boolean optimizeMap) {
