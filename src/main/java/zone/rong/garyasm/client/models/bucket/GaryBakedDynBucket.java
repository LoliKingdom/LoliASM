package zone.rong.garyasm.client.models.bucket;
...
public class GaryBakedDynBucket extends BakedItemModel {
    ...
    public GaryBakedDynBucket(ModelDynBucket parent, ImmutableList<BakedQuad> quads, TextureAtlasSprite particle, VertexFormat format, ImmutableMap<ItemCameraTransforms.TransformType, TRSRTransformation> transforms, boolean untransformed) {
        super(quads, particle, transforms, GaryBakedDynBucketOverrdeList.INSTANCE, untransformed);
        this.parent = parent;
        this.format = format;
        this.bucketVariants = CacheBuilder.newBuilder().weakValues().build();
    }

    private static final class GaryBakedDynBucketOverrdeList extends ItemOverrideList {

        private static final GaryBakedDynBucketOverrdeList INSTANCE = new GaryBakedDynBucketOverrdeList();

        private GaryBakedDynBucketOverrdeList() {
        ...
        public IBakedModel handleItemState(IBakedModel originalModel, ItemStack stack, @Nullable World world, @Nullable EntityLivingBase entity) {
            ...
            GaryBakedDynBucket bakedModel = (GaryBakedDynBucket) originalModel;
            try {
        ...
        private IBakedModel bake(GaryBakedDynBucket bakedModel, String fluidName) {
