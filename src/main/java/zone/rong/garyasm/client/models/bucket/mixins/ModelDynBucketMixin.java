package zone.rong.garyasm.client.models.bucket.mixins;
...
import static zone.rong.garyasm.bakedquad.BakedQuadFactory.*;
import static zone.rong.garyasm.client.models.bucket.GaryBakedDynBucket.*;
...
public abstract class ModelDynBucketMixin implements IModel {
    ...
    public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        ...
        return new GaryBakedDynBucket((ModelDynBucket) (Object) this, builder.build(), particleSprite, format, transformMap, transform.isIdentity());
    }
}
